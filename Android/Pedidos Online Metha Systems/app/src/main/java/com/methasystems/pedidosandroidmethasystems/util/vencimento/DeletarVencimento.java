...
public class DeletarVencimento extends Thread {
    ...
    public DeletarVencimento(Vencimento obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosVencimento.php");
