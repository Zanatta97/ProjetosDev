...
public class GetEmpresa extends Thread {
    ...
    public GetEmpresa(Context context, int idEmpresa){
        ...
        builder.appendQueryParameter(EmpresaDataModel.getCodigoPk(), String.valueOf(idEmpresa));
