...
public class GetGrupoLogin extends Thread{
    ...
    GrupoLoginController controller;
    String result;
    ...
    public GetGrupoLogin(Context context, int idGrupoLogin){
        ...
        controller = new GrupoLoginController(context);

        //Adiciona um parâmetro no URI
        builder.appendQueryParameter("app", "ControleEntradas");
        builder.appendQueryParameter(GrupoLoginDataModel.getCodigoPk(), String.valueOf(idGrupoLogin));
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIGetGrupoLogin.php");
    ...
    protected void onPostExecute(String result){
        ...
        try {
            ...
            if (jsonArray.length() != 0){
                ...
                controller.deletarTabela(GrupoLoginDataModel.getTABELA());
                controller.criarTabela(GrupoLoginDataModel.criarTabela());
