...
public class DeletarGrupoLogin extends Thread {
    ...
    public DeletarGrupoLogin(GrupoLogin obj, Context context){
        //Instancia o URI
        ...
        builder.appendQueryParameter(GrupoLoginDataModel.getCodigoPk(), String.valueOf(obj.getCodigoPk()));
    }
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosGrupoLogin.php");
