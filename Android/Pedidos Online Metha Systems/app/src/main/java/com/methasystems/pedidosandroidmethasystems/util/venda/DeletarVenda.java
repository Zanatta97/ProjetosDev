...
public class DeletarVenda extends Thread{
    ...
    public DeletarVenda(Venda obj, Context context){
        //Instancia o URI
        ...
        builder.appendQueryParameter(VendaDataModel.getCodigoPk(), String.valueOf(obj.getCodigoPk()));
    }
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosVenda.php");
