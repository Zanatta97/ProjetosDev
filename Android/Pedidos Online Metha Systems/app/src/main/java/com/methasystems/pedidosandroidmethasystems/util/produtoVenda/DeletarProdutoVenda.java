...
public class DeletarProdutoVenda extends Thread {
    ...
    public DeletarProdutoVenda(ProdutoVenda obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosProdVendas.php");
