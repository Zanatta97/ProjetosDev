...
public class IncluirRemessa extends Thread {
    ...
    public IncluirRemessa(Remessa obj, Context context){
        ...
        builder.appendQueryParameter(RemessaDataModel.getCnpj(), obj.getCnpj());
        builder.appendQueryParameter(RemessaDataModel.getNroRemessa(), String.valueOf(obj.getNroRemessa()));
        builder.appendQueryParameter(RemessaDataModel.getDataRemessa(), String.valueOf(obj.getDataRemessa()));
        builder.appendQueryParameter(RemessaDataModel.getLoginEmpresa(), obj.getLoginEmpresa());
        builder.appendQueryParameter(RemessaDataModel.getGrupoEmpresa(), obj.getGrupoEmpresa());
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIIncluirDadosRemessa.php");
