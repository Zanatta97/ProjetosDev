...
public class DeletarUsuario extends Thread {
    ...
    public DeletarUsuario(Usuario obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosUsuario.php");
