...
public class AlterarVencimento extends Thread {
    ...
    public AlterarVencimento(Vencimento obj, Context context){
        //Instancia o URI
        ...
        builder.appendQueryParameter(VencimentoDataModel.getCodigoPk(), String.valueOf(obj.getCodigoPk()));
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIAlterarDadosVencimento.php");
