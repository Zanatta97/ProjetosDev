...
public class AlterarGrupoLogin extends Thread {
    ...
    public AlterarGrupoLogin(GrupoLogin obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIAlterarDadosGrupoLogin.php");
