...
public class AlterarRemessa extends Thread {
    ...
    public AlterarRemessa(Remessa obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIAlterarDadosRemessa.php");
