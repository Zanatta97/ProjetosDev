...
public class DeletarModalidadePagamento extends Thread {
    ...
    public DeletarModalidadePagamento(ModalidadePagamento obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosModPagamento.php");
