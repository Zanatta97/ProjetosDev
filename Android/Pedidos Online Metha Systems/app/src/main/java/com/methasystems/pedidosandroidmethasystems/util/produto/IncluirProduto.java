...
public class IncluirProduto extends Thread {
    ...
    public IncluirProduto(Produto obj, Context context){
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIIncluirDadosProduto.php");
