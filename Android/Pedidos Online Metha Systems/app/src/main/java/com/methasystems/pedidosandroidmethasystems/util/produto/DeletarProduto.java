...
public class DeletarProduto extends Thread {
    ...
    public DeletarProduto(Produto obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosProduto.php");
