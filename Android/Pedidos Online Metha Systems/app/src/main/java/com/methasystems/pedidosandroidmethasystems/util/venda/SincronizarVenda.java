...
public class SincronizarVenda extends Thread {
    ...
    public SincronizarVenda(Context context) {
        ...
        builder.appendQueryParameter(VendaDataModel.getLoginEmpresa(), UtilAplicativo.emailUsuario);
    ...
    protected String doInBackground() {
        ...
        try {
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APISincronizarVendas.php");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            VendaController.deletarTabela(VendaDataModel.getTABELA());
            VendaController.criarTabela(VendaDataModel.criarTabela());
            ...
            if (jsonArray.length() != 0) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (jsonObject.getString(VendaDataModel.getTransmitida()).equals("null") || jsonObject.getString(VendaDataModel.getTransmitida()).equals("")) {
                        obj.setTransmitida(false);
                    } else {
                        obj.setTransmitida(jsonObject.getBoolean(VendaDataModel.getTransmitida()));
                    }


                    VendaController.salvar(obj);
