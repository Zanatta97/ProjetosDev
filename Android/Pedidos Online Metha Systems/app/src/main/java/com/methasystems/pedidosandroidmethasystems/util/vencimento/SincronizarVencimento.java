...
public class SincronizarVencimento extends Thread {
    ...
    public SincronizarVencimento(Context context) {

        //Instancia o URI
        this.builder = new Uri.Builder();
        this.context = context;
        this.empresa = empresa;
        VencimentoController = new VencimentoController(context);

        //Adiciona um parâmetro no URI
        builder.appendQueryParameter("app", "PedidosOnline");
        builder.appendQueryParameter(VencimentoDataModel.getLoginEmpresa(), UtilAplicativo.emailUsuario);
    ...
    protected String doInBackground() {
        ...
        try {
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APISincronizarVencimentos.php");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            VencimentoController.deletarTabela(VencimentoDataModel.getTABELA());
            VencimentoController.criarTabela(VencimentoDataModel.criarTabela());
            ...
            if (jsonArray.length() != 0) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    VencimentoController.salvar(obj);
