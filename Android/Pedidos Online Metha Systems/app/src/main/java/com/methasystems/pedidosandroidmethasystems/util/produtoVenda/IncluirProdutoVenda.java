...
public class IncluirProdutoVenda extends Thread {
    ...
    public IncluirProdutoVenda(ProdutoVenda obj, Context context){
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIIncluirDadosProdVendas.php");
