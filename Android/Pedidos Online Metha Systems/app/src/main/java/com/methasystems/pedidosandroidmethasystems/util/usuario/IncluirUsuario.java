...
public class IncluirUsuario extends Thread {
    ...
    public IncluirUsuario(Usuario obj, Context context){
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIIncluirDadosUsuario.php");
