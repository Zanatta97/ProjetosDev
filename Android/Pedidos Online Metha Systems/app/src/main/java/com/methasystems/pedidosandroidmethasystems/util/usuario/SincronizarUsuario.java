...
public class SincronizarUsuario extends Thread{
    ...
    public SincronizarUsuario(Context context) {
        ...
        builder.appendQueryParameter(UsuarioDataModel.getCodigoPk(), UtilAplicativo.emailUsuario);
    ...
    protected String doInBackground() {
        ...
        try {
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APISincronizarUsuarios.php");
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            UsuarioController.deletarTabela(UsuarioDataModel.getTABELA());
            UsuarioController.criarTabela(UsuarioDataModel.criarTabela());
