...
public class AlterarModalidadePagamento extends Thread {
    ...
    public AlterarModalidadePagamento(ModalidadePagamento obj, Context context){
        //Instancia o URI
        ...
        builder.appendQueryParameter(ModalidadePagamentoDataModel.getCodigoPk(), String.valueOf(obj.getCodigoPk()));
        builder.appendQueryParameter(ModalidadePagamentoDataModel.getNome(), obj.getNome());
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIAlterarDadosModPagamento.php");
