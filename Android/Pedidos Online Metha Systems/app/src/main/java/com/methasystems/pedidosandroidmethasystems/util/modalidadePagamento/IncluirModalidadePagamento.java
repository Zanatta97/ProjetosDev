...
public class IncluirModalidadePagamento extends Thread {
    ...
    public IncluirModalidadePagamento(ModalidadePagamento obj, Context context){
    ...
    protected String doInBackground() {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIIncluirDadosModPagamento.php");
