...
public class DeletarAsyncTask extends AsyncTask<String, String, String> {
    ...
    public DeletarAsyncTask(MediaEscolar obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            url = new URL(UtilMediaEscolar.URL_WEB_SERVICE + "APIDeletarDados.php");
