    ...
    <body>
        ...
        <div class="welcome-gallery small-12 columns">
            ...
            <div class="photo-section small-12 columns">
                <img class="homepage-main-photo" src="img/main-photo-pdf.jpg" alt="slider imagem 1">
            </div>
        ...
        <div class="about-us small-11 large-12 columns no-padding small-centered">
            ...
            <div class="global-page-container">
                ...
                <hr></hr>
                    ...
                    <img src="img/fachada-pdf.jpg" alt="fachada do restaurante">
                ...
                <div class="reservation-form small-12 columns no-padding">
                    ...
                    <form action="script-reserva.php" method="get">
                        ...
                        <div id='teste' class="form-part2 small-12 large-3 xlarge-3 end columns no-padding">
                            <input type="text" name="telefone" class="field" placeholder="Telefone" id="telefone"/>
                            
                            <input type="datetime-local" name="data" class="field" placeholder="Data e hora" id="data"/>

                            <input type="number" min=0 step=1 name="pessoas" class="field" placeholder="Número de pessoas"/>

                            <input type="submit" name="submit" value="Reservar" id="btnSubmit" class="button" disabled/>
                           
                            <!--Máscara do campo Telefone e data-->
                            <script type="text/javascript">
                                $("#telefone").mask("(00) 90000-0000");

                                // Detecta se é Firefox 1.0+
