...
import com.example.controleentradacliente.controller.EmpresaController;
import com.example.controleentradacliente.controller.ReservaController;
...
public class GetReservaAsyncTask extends AsyncTask<String, String, String> {
    ...
    public GetReservaAsyncTask(Context context, int idReserva){
        ...
        controller = new ReservaController(context);

        //Adiciona um parâmetro no URI
        builder.appendQueryParameter("app", "ControleEntradas");
        builder.appendQueryParameter(ReservaDataModel.getIdPk(), String.valueOf(idReserva));
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIGetReserva.php");
    ...
    protected void onPostExecute(String result){
        ...
        try {
            ...
            if (jsonArray.length() != 0){
                ...
                controller.deletarTabela(ReservaDataModel.getTABELA());
                controller.criarTabela(ReservaDataModel.criarTabela());
