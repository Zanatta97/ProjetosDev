...
public class IncluirClienteAsyncTask extends AsyncTask<String, String, String> {
    ...
    public IncluirClienteAsyncTask(Cliente obj, Context context){
        ...
        builder.appendQueryParameter(ClienteDataModel.getEmail(), obj.getEmail());
        builder.appendQueryParameter(ClienteDataModel.getSenha(), obj.getSenha());
        builder.appendQueryParameter(ClienteDataModel.getTelefone(), obj.getTelefone());
        builder.appendQueryParameter(ClienteDataModel.getStatus(), obj.getStatus());
        builder.appendQueryParameter(ClienteDataModel.getTokenFirebase(), obj.getTokenFirebase());
        //TODO: Passar o restante dos atributos para o webservice
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIIncluirDadosCliente.php");
