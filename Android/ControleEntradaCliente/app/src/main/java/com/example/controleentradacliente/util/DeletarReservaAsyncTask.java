...
public class DeletarReservaAsyncTask extends AsyncTask<String, String, String> {
    ...
    public DeletarReservaAsyncTask(Reserva obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosReserva.php");
