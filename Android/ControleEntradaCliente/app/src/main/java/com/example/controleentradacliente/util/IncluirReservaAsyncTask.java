...
public class IncluirReservaAsyncTask extends AsyncTask<String, String, String> {
    ...
    public IncluirReservaAsyncTask(Reserva obj, Context context){
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIIncluirDadosReserva.php");
