...
public class DeletarEmpresaAsyncTask extends AsyncTask<String, String, String> {
    ...
    public DeletarEmpresaAsyncTask(Empresa obj, Context context){
        //Instancia o URI
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIDeletarDadosEmpresa.php");
