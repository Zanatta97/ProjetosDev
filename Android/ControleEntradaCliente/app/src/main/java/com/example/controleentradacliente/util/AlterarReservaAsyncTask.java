...
import com.example.controleentradacliente.dataModel.ReservaDataModel;
import com.example.controleentradacliente.model.Empresa;
import com.example.controleentradacliente.model.Reserva;
...
public class AlterarReservaAsyncTask extends AsyncTask<String, String, String> {
    ...
    public AlterarReservaAsyncTask(Reserva obj, Context context){
        //Instancia o URI
        ...
        builder.appendQueryParameter(ReservaDataModel.getIdPk(), String.valueOf(obj.getIdPk()));
        builder.appendQueryParameter(ReservaDataModel.getIdCliente(), String.valueOf(obj.getIdCliente()));
        builder.appendQueryParameter(ReservaDataModel.getNomeCliente(), obj.getNomeClliente());
        builder.appendQueryParameter(ReservaDataModel.getIdEmpresa(), String.valueOf(obj.getIdEmpresa()));
        builder.appendQueryParameter(ReservaDataModel.getQtdPessoas(), String.valueOf(obj.getQtdPessoas()));
        builder.appendQueryParameter(ReservaDataModel.getHoraReserva(), String.valueOf(obj.getHoraReserva()));
        builder.appendQueryParameter(ReservaDataModel.getStatus(), obj.getStatus());
        builder.appendQueryParameter(ReservaDataModel.getTelefoneCliente(), obj.getTelefoneCliente());
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            url = new URL(UtilAplicativo.URL_WEB_SERVICE + "APIAlterarDadosReserva.php");
