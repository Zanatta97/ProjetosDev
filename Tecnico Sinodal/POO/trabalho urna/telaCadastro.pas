...
begin
  ...
  begin
    ...
    ShowMessage ('Número Invalido' + #10 + 'O Número deve conter 5 dígitos')
    else
    begin
  ...
  if length(edNumero.Text) <> 4 then
    ShowMessage ('Número Invalido' + #10 + 'O Número deve conter 4 dígitos')
    else
    begin
  ...
  begin
    ...
    ShowMessage ('Número Invalido' + #10 + 'O Número deve conter 3 dígitos')
    else
    begin
  ...
  begin
    ...
    ShowMessage ('Número Invalido' + #10 + 'O Número deve conter 2 dígitos')
    else
    begin
